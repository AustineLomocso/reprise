...
var issue_record_schema_default = {
  $schema: "https://json-schema.org/draft/2020-12/schema",
...
// schemas/site-index.schema.json
var site_index_schema_default = {
  $schema: "https://json-schema.org/draft/2020-12/schema",
  $id: "https://github.com/AustineLomocso/reprise/schemas/site-index.schema.json",
  title: "Reprise site index (data/index.json, generated by build-site)",
  description: "docs/kit/02-specs/data-contracts.md, 'Site index', with data_source (ADR-13).",
  type: "object",
  additionalProperties: false,
  required: ["generated_at", "repo", "provider", "data_source", "totals", "issues"],
  properties: {
    generated_at: { type: "string", format: "date-time" },
    repo: { type: "string", pattern: "^[A-Za-z0-9_.-]+/[A-Za-z0-9_.-]+$" },
    provider: { description: "Provider of the most recently updated record; null when there are no records.", enum: ["claude", "bob", null] },
    data_source: { enum: ["sample", "live"] },
    totals: {
      type: "object",
      additionalProperties: false,
      required: [
        "issues",
        "by_state",
        "median_time_to_verdict_ms",
        "median_bobcoins_per_triage",
        "median_tokens_per_triage",
        "fixes_verified",
        "regressions_caught"
      ],
      properties: {
        ...
        median_time_to_verdict_ms: { type: ["number", "null"], minimum: 0 },
        median_bobcoins_per_triage: { type: ["number", "null"], minimum: 0 },
        median_tokens_per_triage: { type: ["number", "null"], minimum: 0 },
        fixes_verified: { type: "integer", minimum: 0 },
        regressions_caught: { type: "integer", minimum: 0 }
      }
    },
    issues: {
      type: "array",
      items: {
        type: "object",
        additionalProperties: false,
        required: ["issue", "title", "state", "verdict", "rate", "sequence", "updated_at", "bobcoins_total", "tokens_total", "pr"],
        properties: {
          issue: { type: "integer", minimum: 1 },
          title: { type: "string" },
          state: {
          ...
          verdict: { enum: ["CONFIRMED", "FLAKY", "DUPLICATE", "NEEDS_INFO", "BLOCKED_ENV", null] },
          rate: { type: ["number", "null"], minimum: 0, maximum: 1 },
          sequence: { type: ["string", "null"], pattern: "^[PFX]*$" },
...
// schemas/reprise-config.schema.json
var reprise_config_schema_default = {
  $schema: "https://json-schema.org/draft/2020-12/schema",
  $id: "https://github.com/AustineLomocso/reprise/schemas/reprise-config.schema.json",
  title: "Reprise target repository config (.reprise.yml)",
  description: 'docs/kit/01-architecture/architecture.md, "Target repo contract". Only version and sandbox.dockerfile are required; every other value has the default shown there (src/config/defaults.ts).',
  type: "object",
  additionalProperties: false,
  required: [
    "version",
...
var intake_schema_default = {
  $schema: "https://json-schema.org/draft/2020-12/schema",
  $id: "https://github.com/AustineLomocso/reprise/schemas/intake.schema.json",
  title: "Intake stage output",
  description: "docs/kit/02-specs/triage-pipeline.md section 2.",
  type: "object",
  additionalProperties: false,
  required: ["fingerprint", "attempt_possible", "missing", "question"],
  properties: {
    fingerprint: {
      type: "object",
      additionalProperties: false,
    ...
    attempt_possible: { type: "boolean" },
    missing: { type: "array", items: { type: "string" } },
    question: { type: "string" }
  }
};

// schemas/dedupe-confirm.schema.json
var dedupe_confirm_schema_default = {
  $schema: "https://json-schema.org/draft/2020-12/schema",
  $id: "https://github.com/AustineLomocso/reprise/schemas/dedupe-confirm.schema.json",
  title: "Dedupe confirmation stage output",
  description: "docs/kit/02-specs/data-contracts.md, 'Stage outputs'.",
  type: "object",
  additionalProperties: false,
  required: ["same_bug", "reason"],
  properties: {
...
var repro_schema_default = {
  $schema: "https://json-schema.org/draft/2020-12/schema",
  $id: "https://github.com/AustineLomocso/reprise/schemas/repro.schema.json",
  title: "Repro stage output (write and revise)",
  description: "docs/kit/02-specs/data-contracts.md, 'Stage outputs'; triage-pipeline.md section 5.",
  type: "object",
  additionalProperties: false,
  required: ["test_file", "signature", "rationale"],
  properties: {
    ...
    signature: {
      ...
      required: ["kind", "pattern"],
      properties: {
        kind: { enum: ["assertion_message", "error_type", "output_regex", "timeout"] },
        pattern: { type: "string", maxLength: 200 }
      }
    },
...
// schemas/rootcause.schema.json
var rootcause_schema_default = {
  $schema: "https://json-schema.org/draft/2020-12/schema",
  $id: "https://github.com/AustineLomocso/reprise/schemas/rootcause.schema.json",
  title: "Root cause stage output",
  description: 'docs/kit/02-specs/triage-pipeline.md section 8. The spec gives only the example value "high" for confidence, so it is not constrained to an enumeration.',
  type: "object",
  additionalProperties: false,
  required: ["summary", "locations", "fix_direction", "confidence"],
  properties: {
    summary: { type: "string" },
    locations: {
      type: "array",
...
// schemas/fix.schema.json
var fix_schema_default = {
  $schema: "https://json-schema.org/draft/2020-12/schema",
  $id: "https://github.com/AustineLomocso/reprise/schemas/fix.schema.json",
  title: "Fix stage output (propose and revise)",
  description: "docs/kit/02-specs/data-contracts.md, 'Stage outputs'.",
  type: "object",
  additionalProperties: false,
  required: ["summary", "files_changed", "risk_notes", "tests_added"],
  properties: {
    summary: { type: "string" },
...
// src/schemas.ts
var SOURCES = {
  "issue-record": issue_record_schema_default,
  "site-index": site_index_schema_default,
  "reprise-config": reprise_config_schema_default,
  intake: intake_schema_default,
  "dedupe-confirm": dedupe_confirm_schema_default,
  repro: repro_schema_default,
  rootcause: rootcause_schema_default,
  fix: fix_schema_default
};
var addFormats = import_ajv_formats.default.default ?? import_ajv_formats.default;
var ajv = new import__.Ajv2020({ allErrors: true, strict: true, allowUnionTypes: true });
addFormats(ajv);
...
function describe(e) {
  ...
  const allowed = e.keyword === "enum" ? ` (${e.params["allowedValues"].map(String).join(", ")})` : "";
...
// src/site/build-site.ts
var TRIAGE_STAGES = /* @__PURE__ */ new Set(["intake", "dedupe", "repro", "rootcause"]);
var RECORD_FILE = /^([1-9][0-9]*)\.json$/;
var BuildSiteError = class extends Error {
...
function buildIndex(records, opts) {
  ...
  const triageTasks = (r) => r.cost.bob_tasks.filter((t) => TRIAGE_STAGES.has(t.stage));
...
async function runBuildSite(args, io, assetsDir = defaultAssetsDir()) {
  try {
